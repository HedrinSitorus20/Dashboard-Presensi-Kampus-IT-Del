                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">Admin 1</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-sm font-weight-bold mb-0">08/01/2023</p>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">Admin 2</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">Admin 2</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-sm font-weight-bold mb-0">08/01/2023</p>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">Admin 3</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <p class="text-sm font-weight-bold mb-0">Admin 3</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-sm font-weight-bold mb-0">08/01/2023</p>
                                    </td>
